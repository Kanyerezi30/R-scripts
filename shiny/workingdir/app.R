...
### Workflows
# When you start working on many shiny apps, writing the basic shiny line codes will become redundant and boring
# So it's better to use a few shortcuts 
# If you already have your app.R open, type shinyapp and then press shift + tab
# Otherwise, go to new project and select Shiny Web Application
